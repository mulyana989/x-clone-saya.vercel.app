      ...
      <div className="relative">
        ...
        <div className="px-4">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <button className="px-4 py-1.5 border border-[#cfd9de] text-white font-bold rounded-full hover:bg-white/10 transition-colors text-sm">
              Edit profil
            </button>
          </div>

          <p className="mb-3 text-[15px]">Digital artisan exploring the pixelated frontier of social media. Level 999 since day one. 👾</p>
